...
class ImprovedNoise {
  static noise(x, y, z) {
    ...
    return Perlerp(
      ...
      Perlerp(
        v,
        Perlerp(u, grad(p[AA], x, y, z), grad(p[BA], x - 1, y, z)),
        Perlerp(u, grad(p[AB], x, y - 1, z), grad(p[BB], x - 1, y - 1, z))
      ),
      Perlerp(
        v,
        Perlerp(u, grad(p[AA + 1], x, y, z - 1), grad(p[BA + 1], x - 1, y, z - 1)),
        Perlerp(
          u,
